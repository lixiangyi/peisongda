...
public class OrderNewFragment extends BaseFragment implements View.OnClickListener, NotificationListener {
...
//            ToastUtil.showToast(ss);
    ...
    void getdata(final int curpage) {
        ...
        new MemberModel().order_list(10, curpage, new BaseModel.BaseModelIB() {
            @Override
            public void StartOp() {
...
//                }
        ...
        //TODO 蓝牙连接打印 copy胡先生的配送端蓝牙 进入之后检测蓝牙；
        //TODO 让后台修改返回数据一次200条
//        return rsb.toString();
        return  "yes";
    }
