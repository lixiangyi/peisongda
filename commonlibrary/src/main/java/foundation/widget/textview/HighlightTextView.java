...
public class HighlightTextView extends AppCompatTextView {
    ...
    private int mSize = 12;//高亮的位置, 默认不高亮
    ...
    public HighlightTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = typedArray.getDimensionPixelSize(R.styleable.HighlightTextView_highlight_size, mSize);
...
//        AbsoluteSizeSpan absoluteSizeSpan = new AbsoluteSizeSpan(mSize);
        builder.setSpan(new ForegroundColorSpan(mHighlightColor), mHighlightPosition, endPosition,
                Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
//        builder.setSpan(absoluteSizeSpan, 0, mHighlightPosition, Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
