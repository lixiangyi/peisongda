...
//        defaultLinePadding = dip2px(context, 16);
    ...
    private void getAttr(AttributeSet attrs) {
        ...
        leftIconWidth = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_sLeftIconWidth, dip2px(mContext,0.5f));
        leftIconHeight = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_sLeftIconHeight, dip2px(mContext,0.5f));
     ...
     * @return 返回对象
     */
    public SuperTextView setRightString(String rightString, int color) {
        rightTextString = rightString;
        if (rightTV == null) {
            initRightText();
        } else {
