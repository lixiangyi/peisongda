package foundation.widget.titlebar;
...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        padding_14 = dip2px(14);
        padding_16 = dip2px(16);
    ...
    private void initView(Context context) {
        ...
        mLeftImage.setPadding(padding_16, padding_16, padding_16, padding_16);
    ...
    public void setLeftImageVewResource(int resId) {
...
//        if (null == action.getText()) {
//            ((ImageView)view).setImageResource(action.getDrawable());
//        }
        return view;
    }
    ...
    private View inflateAction(Action action) {
        ...
        if (TextUtils.isEmpty(action.getText())) {
            ...
            img.setPadding(padding_14, padding_14, padding_14, padding_14);
