...
package foundation.widget.swiperefresh;
...
public class SuperSwipeRefreshLayout extends ViewGroup {
    ...
    public SuperSwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        a.recycle();
        final TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.SuperSwipeRefreshLayout);
        Direction direction
                = Direction.getFromInt(a2.getInt(R.styleable.SuperSwipeRefreshLayout_direction, 0));
...
//    }
    ...
    public interface OnRefreshListener {
        public void onRefresh(Direction direction);
    }
