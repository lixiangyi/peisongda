...
package foundation.widget.refresh.listener;
...
public class RecyclerViewOnScrollListener extends RecyclerView.OnScrollListener {
    private RefreshRecyclerView mPullLoadMoreRecyclerView;

    public RecyclerViewOnScrollListener(RefreshRecyclerView pullLoadMoreRecyclerView) {
