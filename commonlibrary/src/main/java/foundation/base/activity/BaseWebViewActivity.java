...
import foundation.widget.webview.config.BaseWebChromeClient;
import foundation.widget.webview.config.BaseWebViewClient;
import foundation.widget.webview.config.FullscreenHolder;
 ...
 * 进度条、返回网页上一层、显示网页标题
 */
public class BaseWebViewActivity extends BaseActivity implements IWebPageView {
    ...
    protected View onCreateContentView() {
        return inflateContentView(R.layout.activity_web_view);
    }
...
//        webView.addJavascriptInterface(new ImageClickInterface(this), "injectedObject");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        } else if (requestCode == BaseWebChromeClient.FILECHOOSER_RESULTCODE_FOR_ANDROID_5) {
